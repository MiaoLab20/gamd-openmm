...
the system potential energy surface.
"""
import sys
from setuptools import setup, find_packages
import versioneer

short_description = "Gaussian Accelerated Molecular Dynamics (GaMD) is a "\
    "biomolecular enhanced sampling method that works by adding a harmonic "\
    "boost potential to smoothen the system potential energy surface."\
    .split("\n")[0]
