...
PyReweighting-1D.py -input psi.dat -T $TEMPERATURE -cutoff 100 -Xdim -180 180 -disc 6 -Emax 100 -job amdweight_CE -weight graphics/weights.dat | tee -a graphics/reweight-variable-cumulant-expansion-1D.log
...
PyReweighting-1D.py -input phi.dat -T $TEMPERATURE -cutoff 100 -Xdim -180 180 -disc 6 -Emax 100 -job amdweight_CE -weight graphics/weights.dat | tee -a graphics/reweight-variable-cumulant-expansion-1D.log
...
PyReweighting-2D.py -T $TEMPERATURE  -cutoff 100 -input phi-psi.dat -Xdim -180 180 -discX 6 -Ydim -180 180 -discY 6 -Emax 100 -job amdweight_CE -weight graphics/weights.dat | tee -a graphics/reweight-variable-cumulant-expansion-2D.log
...
mv -v weights-c1-phi.dat.xvg graphics-out/
mv -v weights-c2-phi.dat.xvg graphics-out/
mv -v weights-c3-phi.dat.xvg graphics-out/
